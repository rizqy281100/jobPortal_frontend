      ...
      >
        ...
        <div className="w-full lg:hidden">
          ...
          >
            <TabsTrigger
              value="overview"
              className="w-full rounded-md py-2 text-xs sm:text-sm data-[state=active]:bg-primary data-[state=active]:text-primary-foreground"
            >
              Overview
            </TabsTrigger>
            <TabsTrigger
        ...
        <div className="hidden lg:block lg:w-56 lg:flex-shrink-0">
          <TabsList className="flex h-fit w-full flex-col rounded-xl border bg-card p-2">
            <TabsTrigger
              value="overview"
              className="w-full justify-start rounded-md px-4 py-2 text-sm transition data-[state=active]:bg-primary data-[state=active]:text-primary-foreground"
            >
              Overview
            </TabsTrigger>
