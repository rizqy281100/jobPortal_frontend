...
//       <Tabs defaultValue="Personal Information" className="w-full space-y-6">
//         {/* ===== Nested Tabs (dalam Settings) ===== */}
//         <TabsList
//           className="
//             w-full
...
//             className="w-full py-2 text-xs sm:text-sm rounded-lg
...
//           <section className="w-full rounded-2xl border bg-card/80 p-4 sm:p-6 md:p-8 space-y-8">
//             {/* Work Experience */}
//             {/* (ISI WORK, EDUCATION, CERTS kamu tetap – tidak diubah) */}
//             {/* ... SELURUH BAGIAN WORK / EDUCATION / CERTS ASLI DI SINI ... */}
//           </section>
//         </TabsContent>
//       </Tabs>
//     </div>
...
export default function UserSettingsClient() {
  ...
  >([]);
  const [work, setWork] = React.useState<WorkExp[]>([]);
  const [educations, setEducations] = React.useState<Education[]>([]);
  const [certs, setCerts] = React.useState<CertItem[]>([]);
  const [saving, setSaving] = React.useState(false);
  const [loading, setLoading] = React.useState(false);
  ...
  return (
    <div className="w-full space-y-8">
      ...
      >
        ...
        {/* === TABS LIST (1 baris semua device, space-evenly) === */}
        <TabsList
          className="
      w-full
      grid grid-cols-3
    ...
    "
        >
          <TabsTrigger
            value="Personal Information"
            className="
        w-full py-2 text-xs sm:text-sm rounded-md
        data-[state=active]:bg-primary data-[state=active]:text-primary-foreground
      "
          >
            Personal Info
