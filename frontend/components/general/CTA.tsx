        ...
        <div className="grid items-center gap-8 p-6 md:grid-cols-2 md:p-10 lg:p-12">
          ...
          <div>
            <h2 className="text-3xl font-extrabold leading-tight text-white md:text-4xl">
              {t("titleLine1")}
              <br className="hidden text-white md:block dark:text-white" />{" "}
              {t("titleLine2")}
            </h2>
            <p className="mt-3 max-w-xl text-white dark:text-white">
              {t("description")}
            ...
            <div className="mt-6">
              <Button
                ...
                className="h-12 min-w-[160px] bg-amber-300 text-black hover:bg-amber-200"
              >
                <Link href="/learn-more">{t("button")}</Link>
              </Button>
            </div>
          </div>

          {/* Right: marquee logos (tanpa perubahan) */}
          <div className="relative">
            <div className="rounded-[28px] bg-primary-foreground/10 p-4 backdrop-blur">
              <div className="grid grid-cols-3 gap-3 rounded-2xl bg-primary-foreground/10 p-3">
                <MarqueeColumn
...
function MarqueeColumn({
  ...
  return (
    <div
      className="relative h-[230px] overflow-hidden rounded-xl bg-background/60 ring-1 ring-primary-foreground/15"
      style={{
        WebkitMaskImage:
          "linear-gradient(to bottom, transparent, black 12%, black 88%, transparent)",
      }}
